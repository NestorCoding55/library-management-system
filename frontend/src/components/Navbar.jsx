        ...
        <nav className="bg-gradient-to-r from-blue-900 via-indigo-800 to-purple-800 text-white shadow-2xl">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex items-center space-x-4">
                        <button className="relative overflow-hidden group bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <button className="relative overflow-hidden group bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
            ...
            <div className="md:hidden bg-gradient-to-b from-blue-800/90 to-indigo-800/90 backdrop-blur-lg">
                <div className="px-4 py-4 space-y-3">
                    <a href="#" className="block px-4 py-3 text-blue-100 hover:text-white hover:bg-blue-700/30 rounded-xl transition-colors duration-200">
                        Home
                    </a>
                    <a href="#" className="block px-4 py-3 text-blue-100 hover:text-white hover:bg-blue-700/30 rounded-xl transition-colors duration-200">
                        Books
