...
const Books = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            // A. Prepare URLs
            let booksUrl = "http://library-backend.onrender.com/api/books";
            if (categoryFilter) {
                booksUrl = `http://library-backend.onrender.com/api/books/category?category=${encodeURIComponent(categoryFilter)}`;
            }
