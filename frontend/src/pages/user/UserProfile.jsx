...
const UserProfile = () => {
    ...
    const fetchProfileData = async () => {
        try {
            ...
            const userRes = await axios.get("https://library-backend-y49e.onrender.com/api/users/me", config);
    ...
    const handleFileSelect = async (e) => {
        ...
        try {
            const token = localStorage.getItem("token") || sessionStorage.getItem("token");
            const res = await axios.post("https://library-backend-y49e.onrender.com/api/users/upload-photo", formData, {
                headers: {
    ...
    const checkUsernameAvailability = async (username) => {
        ...
        try {
            const response = await axios.get(`https://library-backend-y49e.onrender.com/api/users/check-username?username=${encodeURIComponent(username)}`);
    ...
    const handleUpdateSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.put("https://library-backend-y49e.onrender.com/api/users/me", payload, {
